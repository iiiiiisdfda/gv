...
void BSetOrderCmd::help() const {
    cout << setw(20) << left << "BSETOrder: "
         << "Set BDD variable order from file or DFS PI order." << endl;
}
